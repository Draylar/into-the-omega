...
public class ShapeRendering {
    ...
    public static void quad(int light, float r, float g, float b, MatrixStack matrices, VertexWrapper buffer) {
        quad(light, r, b, g, matrices.peek().getNormalMatrix(), matrices.peek().getPositionMatrix(), buffer);
    }
