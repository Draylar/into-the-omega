...
public class PhasePadBlockEntityRenderer implements BlockEntityRenderer<PhasePadBlockEntity> {

    public PhasePadBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
