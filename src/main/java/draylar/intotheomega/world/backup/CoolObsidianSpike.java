package draylar.intotheomega.world.backup;
...
//public class CoolObsidianSpike extends SiftingStructureStart {
//
//    public CoolObsidianSpike(StructureFeature<DefaultFeatureConfig> feature, int chunkX, int chunkZ, BlockBox box, int references, long seed) {
