...
public class OmegaPlacedFeatures {
    ...
    public static final RegistryEntry<PlacedFeature> OBSIDIAN_SPIKE = PlacedFeatures.register("obsidian_spike", OmegaConfiguredFeatures.OBISDIAN_SPIKE, RarityFilterPlacementModifier.of(100), SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of());
    ...
    public static final RegistryEntry<PlacedFeature> COARSE_PATCH = PlacedFeatures.register("coarse_patch", OmegaConfiguredFeatures.COARSE_PATCH, RarityFilterPlacementModifier.of(100), SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of());
