...
public class OmegaPlacedFeatures {
    ...
    public static final RegistryEntry<PlacedFeature> TALL_CHORUS_PLANT = PlacedFeatures.register("tall_chorus_plant", OmegaConfiguredFeatures.TALL_CHORUS_PLANT, CountPlacementModifier.of(UniformIntProvider.create(4, 8)), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of());
