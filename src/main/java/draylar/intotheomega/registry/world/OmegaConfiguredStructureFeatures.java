...
public class OmegaConfiguredStructureFeatures {
    ...
    public static final RegistryEntry<ConfiguredStructureFeature<?, ?>> SLIME_TENDRIL = register(key("slime_tendril"), OmegaStructureFeatures.SLIME_TENDRIL.configure(new DefaultFeatureConfig(), OmegaBiomeTags.OMEGA_SLIME_SPIRAL));
