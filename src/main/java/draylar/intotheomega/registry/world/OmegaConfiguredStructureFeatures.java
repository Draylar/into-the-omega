...
//    public static final RegistryEntry<ConfiguredStructureFeature<?, ?>> TEST_SF = register(key("test_sf"), OmegaStructureFeatures.TEST_SF.configure(new DefaultFeatureConfig(), BiomeTags.IS_FOREST));
    ...
    public static final RegistryEntry<ConfiguredStructureFeature<?, ?>> SPIRAL_DUNGEON = register(key("spiral_dungeon"), OmegaStructureFeatures.SPIRAL_DUNGEON.configure(new DefaultFeatureConfig(), OmegaBiomeTags.GENERIC_END_STRUCTURE));
