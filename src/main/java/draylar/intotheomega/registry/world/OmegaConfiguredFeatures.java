...
public class OmegaConfiguredFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<DiskFeatureConfig, ?>> COARSE_PATCH = register("coarse_dirt_patch", OmegaWorld.END_PATCH, new DiskFeatureConfig(Blocks.COARSE_DIRT.getDefaultState(), UniformIntProvider.create(3, 4), 3, ImmutableList.of(Blocks.END_STONE.getDefaultState())));
