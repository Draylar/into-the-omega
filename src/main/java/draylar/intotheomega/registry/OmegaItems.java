...
//    public static final Item BREATH_OF_THE_END = register("breath_of_the_end", new Item(new Item.Settings().rarity(Rarity.EPIC).group(IntoTheOmega.GROUP).maxCount(1)));
    ...
    public static final Item VOID_BEETLE_SPAWN_EGG = register("void_beetle_spawn_egg", new SpawnEggItem(OmegaEntities.VOID_BEETLE, 0xffffff, 0xffffff, new Item.Settings().group(IntoTheOmega.GROUP)));
    ...
    public static final Item SLIMEFALL = register("slimefall", new SlimefallItem(new Item.Settings().group(IntoTheOmega.GROUP).rarity(Rarity.EPIC)));
...
//    public static final Item TRUE_EOE_SPAWN_EGG = register("true_eye_of_ender_spawn_egg", new SpawnEggItem(OmegaEntities.TRUE_EYE_OF_ENDER, 0, 0, new Item.Settings().group(IntoTheOmega.GROUP)));
    ...
    public static final Item ENDERANG = register("enderang", new Item(new Item.Settings().group(IntoTheOmega.GROUP).rarity(Rarity.EPIC)));
    ...
    public static final Item SLIME_STRUCTURE_GENERATOR = register("slime_structure_generator", new SlimeStructureGeneratorItem(new Item.Settings().rarity(Rarity.EPIC)));
