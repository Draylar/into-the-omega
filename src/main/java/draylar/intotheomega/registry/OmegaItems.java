...
//    public static final Item BREATH_OF_THE_END = register("breath_of_the_end", new Item(new Item.Settings().rarity(Rarity.EPIC).group(IntoTheOmega.GROUP).maxCount(1)));
    ...
    public static final Item OMEGA_SLIME_SOAKER = register("omega_slime_squirter", new SlimeSoakerItem(new Item.Settings().group(IntoTheOmega.GROUP).rarity(Rarity.EPIC)));
    ...
    public static final Item CHILLED_VOID_HELMET = register("chilled_void_helmet", new ArmorItem(ArmorMaterials.DIAMOND, EquipmentSlot.HEAD, new Item.Settings().group(IntoTheOmega.GROUP).rarity(Rarity.EPIC)));
