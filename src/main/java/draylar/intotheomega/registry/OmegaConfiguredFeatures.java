...
public class OmegaConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> COARSE_PATCH = register("coarse_dirt_patch", OmegaWorld.END_PATCH.configure(new DiskFeatureConfig(Blocks.COARSE_DIRT.getDefaultState(), UniformIntDistribution.of(4, 3), 3, ImmutableList.of(Blocks.END_STONE.getDefaultState()))).decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP).repeat(2));
    public static final ConfiguredFeature<?, ?> ENDSTONE_PATCH = register("end_stone_patch", OmegaWorld.END_PATCH.configure(new DiskFeatureConfig(Blocks.END_STONE.getDefaultState(), UniformIntDistribution.of(4, 3), 3, ImmutableList.of(OmegaBlocks.CHORUS_GRASS.getDefaultState()))).decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP).repeat(2));
    ...
    public static final ConfiguredFeature<?, ?> CRYSTALITE_SPIKE = register("crystalite_spike", OmegaWorld.CRYSTALITE_SPIKE.configure(FeatureConfig.DEFAULT).decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP).repeat(1));
    public static final ConfiguredFeature<?, ?> CRYSTALITE_CAVERN = register("crystalite_cavern", OmegaWorld.CRYSTALITE_CAVERN.configure(FeatureConfig.DEFAULT).decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP_SPREAD_DOUBLE));
    public static final ConfiguredFeature<?, ?> DARK_SAKURA_TREE = register("dark_sakura_tree", OmegaWorld.DARK_SAKURA_TREE.configure(FeatureConfig.DEFAULT).decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP));
